...
function OutImageThroughCycle($path ,$i){ 
	...
	. '<img src=' . $path[$i] . ' alt="Image" style="width: 235px; padding-right:5px; text-align:center;" />
	<p>
		<b style="color: red">*</b> 
		<input type="text" name="name_image_' . $i . '" placeholder="Введите название"/>
	</p>          
	<p>
		<b>
			&nbsp;Размер фото: 
	...
	<p>
		...
		<p><input type="text" id="text_comment_' . $i . '" name="comment_' . $i . '" 
			style="width: 250px; padding-bottom: 100px; margin-top:10px; vertical-align:top;"></p>
		</p>
	</div>';
}
